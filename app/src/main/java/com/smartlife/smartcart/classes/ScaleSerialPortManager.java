...
public class ScaleSerialPortManager {
    private static final String TAG = "ScaleSerialPortManager";

    private ScaleReadThread mReadThread;
    ...
    private static class InstanceHolder {
        public static ScaleSerialPortManager sManager = new ScaleSerialPortManager();
    }

    public static ScaleSerialPortManager instance() {
        return ScaleSerialPortManager.InstanceHolder.sManager;
    }

    private SerialPort mSerialPort;

    private ScaleSerialPortManager() {
    }
    ...
    public SerialPort open(String devicePath, String baudrateString) {
        ...
        try {
            ...
            mReadThread = new ScaleReadThread(mSerialPort.getInputStream());
